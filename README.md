...
![Информация](files/images/project_view/Пользователь(1).jpg)

### Функционал администратора

**Администратор 1** - меню администратора
![Информация](files/images/project_view/Администратор(1).jpg)
...
- ⛽ **Где бенз** — поиск топлива по городам
...
│       ├── gde_benz/            # Поиск бензина по городу
